...
class DotpayNotificationTest < Test::Unit::TestCase
  ...
  def test_accessors
    ...
    assert_equal "42655-TST11", @dotpay.t_id
    ...
    assert_equal "455acc67fa94b1d6e5c0f7ebd7b032c9", @dotpay.md5
  end

  def test_accessors_error
    assert !@dotpay_error.complete?
    assert_equal "3", @dotpay_error.t_status
    assert_equal "849239f5ef107d202efb129d6d262e27", @dotpay_error.md5
  end
  ...
  def test_pin_required
    assert_raises ArgumentError do
      Dotpay::Notification.new(http_raw_data, {})
    end
    assert_nothing_raised do
      Dotpay::Notification.new(http_raw_data, :pin => 'secret')
    end
  end

  def test_generate_signature_string
    assert_equal "my3secret1pinCod:42655:1234567890:42655-TST11:150.00:example@email.com:::::2",
                 @dotpay.generate_signature_string
  end

  def test_generate_md5check
    assert_equal "455acc67fa94b1d6e5c0f7ebd7b032c9", @dotpay.generate_signature
  end

  def test_generate_md5check_when_error
      assert_equal "849239f5ef107d202efb129d6d262e27", @dotpay_error.generate_signature
  end
  ...
  def http_raw_data_error
    ...
    "&version=1.4&channel=&code=&service=&md5=849239f5ef107d202efb129d6d262e27"
  end
end
