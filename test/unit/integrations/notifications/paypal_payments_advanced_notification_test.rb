...
class PaypalPaymentsAdvancedNotificationTest < Test::Unit::TestCase
  include ActiveMerchant::Billing::Integrations

  def setup
    @payflow = ActiveMerchant::Billing::Integrations::PaypalPaymentsAdvanced.notification(http_raw_data)
  end
