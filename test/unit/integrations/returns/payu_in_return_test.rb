...
class PayuInReturnTest < Test::Unit::TestCase
  ...
  def setup
    ...
    @payu = PayuIn::Return.new(http_raw_data_success, :credential1 => 'C0Dr8m', :credential2 => '3sf0jURk', :params => params)
  end
  ...
  def setup_failed_return
    ...
    @payu = PayuIn::Return.new(http_raw_data_failure, :credential1 => 'C0Dr8m', :credential2 => '3sf0jURk', :params => params)
  end
