...
class PayuInReturnTest < Test::Unit::TestCase
  ...
  def setup
    ...
    @payu = PayuIn::Return.new(http_raw_data_success, :merchant_id => 'C0Dr8m', :secret_key => '3sf0jURk', :params => params)
  end
  ...
  def setup_failed_return
    ...
    @payu = PayuIn::Return.new(http_raw_data_failure, :merchant_id => 'C0Dr8m', :secret_key => '3sf0jURk', :params => params)
  end
