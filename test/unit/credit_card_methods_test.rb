...
class CreditCardMethodsTest < Test::Unit::TestCase
  ...
  def test_should_detect_mastercard_and_maestro
    assert_equal 'maestro', CreditCard.brand?('6771890000000000')
  ...
  def test_should_detect_laser_cards_as_maestro
    # 16 digits
    assert_equal 'maestro', CreditCard.brand?('6304985028090561')

    # 18 digits
    assert_equal 'maestro', CreditCard.brand?('630498502809056151')

    # 19 digits
    assert_equal 'maestro', CreditCard.brand?('6304985028090561515')

    # 17 digits
    assert_equal 'maestro', CreditCard.brand?('63049850280905615')

    # 15 digits
    assert_equal 'maestro', CreditCard.brand?('630498502809056')

    # Alternate format
    assert_equal 'maestro', CreditCard.brand?('6706950000000000000')

    # Alternate format (16 digits)
    assert_equal 'maestro', CreditCard.brand?('6706123456789012')

    # New format (16 digits)
    assert_equal 'maestro', CreditCard.brand?('6709123456789012')

    # Ulster bank (Ireland) with 12 digits
    assert_equal 'maestro', CreditCard.brand?('677117111234')
  end
  ...
  def test_matching_discover_and_unionpay_card
