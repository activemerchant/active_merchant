...
class OrbitalGatewayTest < Test::Unit::TestCase
  ...
  def test_schema_for_soft_descriptors_with_network_tokenization_credit_card_data
    ...
    stub_comms do
      ...
      assert_match %{<SDMerchantEmail>email@example<\/SDMerchantEmail><CardIndicators>y</CardIndicators><DPANInd>Y<\/DPANInd><DigitalTokenCryptogram}, data.gsub(/\s+/, '')
    end.respond_with(successful_purchase_response)
  end
