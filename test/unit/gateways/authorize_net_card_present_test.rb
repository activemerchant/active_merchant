...
class AuthorizeNetCardPresentTest < Test::Unit::TestCase
  def setup
    ...
    @amount = 100
    @credit_card = credit_card(nil, :track_data => 'foobar')
  ...
  def test_successful_authorization
    ...
    assert_equal '000000', response.params['authorization_code']
  end
  ...
  def test_successful_purchase
    ...
    assert_equal 'X931M4', response.params['authorization_code']
  end
