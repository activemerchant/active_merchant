...
class ConektaTest < Test::Unit::TestCase
  ...
  def failed_login_response
    {'object' => 'error','type' => 'authentication_error','message' => 'Unrecognized authentication token'}.to_json
  end
