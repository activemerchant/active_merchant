...
class CardknoxTest < Test::Unit::TestCase
  ...
  def test_successful_credit_card_purchase
    ...
    response = @gateway.purchase(@amount, @credit_card, @options)
    assert_success response
    assert_equal '16268727;f0b84a5b181749b4b0d77f6291a753ab;cc:sale', response.authorization
  end
  ...
  def test_successful_authorize
    ...
    assert_equal '15312316;62d4fd9aebd240659d68ffaa156d1788;cc:authonly', auth.authorization
  end
  ...
  def test_successful_capture 
    ...
    assert_equal '15312316;f9097326fb1c4976a6da75ccb872f28a;cc:capture', capture.authorization
  end
  ...
  def test_successful_check_refund_void 
    ...
    assert_equal '16276884;;check:voidrefund', void.authorization
  end
  ...
  def test_failed_refund
    ...
    assert_equal '15308026;;cc:refund', response.authorization
  end

  def test_successful_credit_card_void
    @gateway.expects(:ssl_post).returns(successful_void_response)

    assert void = @gateway.void('15308171;;cc:sale')
    assert_success void
    assert_equal 'Success', void.message
    assert_equal '15308171;;cc:voidrelease', void.authorization
  end
