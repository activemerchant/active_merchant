...
class PaymentExpressTest < Test::Unit::TestCase
  ...
  def billing_id_token_purchase(options = {})
    "<GenerateRequest><BillingId>#{options[:billing_id]}</BillingId><AmountInput>1.00</AmountInput><CurrencyInput>NZD</CurrencyInput><TxnId>aaa050be9488e8e4</TxnId><MerchantReference>Store purchase</MerchantReference><EnableAvsData>1</EnableAvsData><AvsAction>1</AvsAction><AvsStreetAddress>1234 My Street</AvsStreetAddress><AvsPostCode>K1C2N6</AvsPostCode><PxPayUserId>LOGIN</PxPayUserId><PxPayKey>PASSWORD</PxPayKey><TxnType>Purchase</TxnType></GenerateRequest>"
  end
  ...
  def transcript
    %(<GenerateRequest><CardHolderName>Longbob Longsen</CardHolderName><CardNumber>4111111111111111</CardNumber><DateExpiry>0916</DateExpiry><Cvc2>123</Cvc2><Cvc2Presence>1</Cvc2Presence><AmountInput>1.00</AmountInput><CurrencyInput>NZD</CurrencyInput><TxnId>59956b468905bde7</TxnId><MerchantReference>Store purchase</MerchantReference><EnableAvsData>1</EnableAvsData><AvsAction>1</AvsAction><AvsStreetAddress>456 My Street</AvsStreetAddress><AvsPostCode>K1C2N6</AvsPostCode><PxPayUserId>WaysactDev</PxPayUserId><PxPayKey>kvr52dw9</PxPayKey><TxnType>Purchase</TxnType></GenerateRequest>)
  end

  def scrubbed_transcript
    %(<GenerateRequest><CardHolderName>Longbob Longsen</CardHolderName><CardNumber>[FILTERED]</CardNumber><DateExpiry>0916</DateExpiry><Cvc2>[FILTERED]</Cvc2><Cvc2Presence>1</Cvc2Presence><AmountInput>1.00</AmountInput><CurrencyInput>NZD</CurrencyInput><TxnId>59956b468905bde7</TxnId><MerchantReference>Store purchase</MerchantReference><EnableAvsData>1</EnableAvsData><AvsAction>1</AvsAction><AvsStreetAddress>456 My Street</AvsStreetAddress><AvsPostCode>K1C2N6</AvsPostCode><PxPayUserId>WaysactDev</PxPayUserId><PxPayKey>[FILTERED]</PxPayKey><TxnType>Purchase</TxnType></GenerateRequest>)
  end
end
