...
class PayuCoTest < Test::Unit::TestCase
  def setup
  ...
  def test_successful_refund
    ...
    refund_options = {order_id: "123456", reason: "reason for the refund", transaction_id: "123-456-789-012"}
  ...
  def test_successful_void
    ...
    void_options = {order_id: "123456", reason: "reason for the refund", transaction_id: "123-456-789-012"}
