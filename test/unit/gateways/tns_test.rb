...
class TnsTest < Test::Unit::TestCase
  ...
  def test_passing_billing_address
    stub_comms(@gateway, :ssl_request) do
      ...
      assert_equal('1234 My Street', parsed['billing']['address']['street'])
