...
class MidtransTest < Test::Unit::TestCase
  def setup
    @gateway = MidtransGateway.new(some_credential: 'login', another_credential: 'password')
  ...
  def successful_purchase_response
    %(
      ...
      $ DEBUG_ACTIVE_MERCHANT=true ruby -Itest \
        test/remote/gateways/remote_midtrans_test.rb \
