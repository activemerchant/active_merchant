...
SSL established
<- "POST /gw/api/transact.php HTTP/1.1\r\nContent-Type: application/x-www-form-urlencoded\r\nAccept-Encoding: gzip;q=1.0,deflate;q=0.6,identity;q=0.3\r\nAccept: */*\r\nUser-Agent: Ruby\r\nConnection: close\r\nHost: secure.centralams.com\r\nContent-Length: 249\r\n\r\n"
<- "amount=1.03&currency=USD&ccnumber=[FILTERED]&ccexp=[FILTERED]&firstname=[FILTERED]&lastname=[FILTERED]&address1=[FILTERED]&address2=[FILTERED]&city=[FILTERED]&state=[FILTERED]&zip=[FILTERED]&country=US&phone=[FILTERED]&type=&password=[FILTERED]&username=testintegrationc"
-> "HTTP/1.1 200 OK\r\n"
-> "Date: Tue, 21 Apr 2015 23:27:05 GMT\r\n"
-> "Server: Apache\r\n"
-> "Content-Length: 132\r\n"
...
-> "\r\n"
reading 132 bytes...
-> "response=1&responsetext=SUCCESS&authcode=[FILTERED]&transactionid=2654605773&avsresponse=N&cvvresponse=&orderid=&type=&response_code=100"
read 132 bytes
Conn close
    POST_SCRUBBED
  end
