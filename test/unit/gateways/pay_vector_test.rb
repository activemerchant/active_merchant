...
class PayVectorTest < Test::Unit::TestCase
  def setup
    Base.gateway_mode = :test

    @gateway = PayVectorGateway.new(:login => 'login', :password => 'password')
          ...
          <CardDetailsTransactionResponse xmlns="https://www.thepaymentgateway.net/">
            ...
            <TransactionOutputData CrossReference="100115170338509401960011">
              ...
              <GatewayEntryPoints>
                ...
                <GatewayEntryPoint EntryPointURL="https://gw3.payvector.net/" Metric="300" />
              </GatewayEntryPoints>
