...
class DLocalTest < Test::Unit::TestCase
  ...
  def test_supported_card_types
    assert_equal DLocalGateway.supported_cardtypes, %i[visa master american_express discover jcb diners_club maestro naranja cabal elo alia carnet patagonia_365 sol]
  end
