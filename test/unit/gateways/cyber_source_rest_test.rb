...
class CyberSourceRestTest < Test::Unit::TestCase
  ...
  def test_supported_card_types
    assert_equal CyberSourceRestGateway.supported_cardtypes, %i[visa master american_express discover diners_club jcb maestro elo union_pay cartes_bancaires mada patagonia365]
  end
