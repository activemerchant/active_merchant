...
class TransactProTest < Test::Unit::TestCase
  ...
  def test_failed_purchase
    ...
    assert_equal 'fed54b10b610bb760816aad42721672e8fd19327', response.params['id']
  end
  ...
  def test_failed_authorize
    ...
    assert_equal 'Failed', response.message
    assert_equal '908', response.params['result_code']
    assert_equal 'c9c789a575ba8556e2c5f56174d859c23ac56e09', response.params['id']
  end
  ...
  def test_partial_capture
    ...
    capture = @gateway.capture(@amount-1, '3d25ab044075924479d3836f549b015481d15d74|100')
  ...
  def test_successful_refund
    ...
    assert_equal '3d25ab044075924479d3836f549b015481d15d74|0', refund.authorization
  end
  ...
  def test_partial_refund
    ...
    assert_success refund
    assert_equal 'Refund Success', refund.message
    assert_equal '3d25ab044075924479d3836f549b015481d15d74|1', refund.authorization
  end
  ...
  def test_successful_void
    ...
    assert_success void
    assert_equal '3d25ab044075924479d3836f549b015481d15d74|0', void.authorization
  ...
  def test_failed_void
    ...
    void = @gateway.void('')
    assert_failure void
    assert_match /fail/i, void.message
  end
