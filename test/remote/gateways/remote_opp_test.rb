...
# ****************************************** SUCCESSFUL TESTS ******************************************
  ...
  # def test_purchases_with_registration
    # @options[:description] = __method__
    # @options[:createRegistration] = true
    # purchase = @gateway.purchase(@amount, @amex_card, @options)
    # assert_success purchase
#     
    # @options[:registrationId] = purchase.params['registrationId']
    # assert repeated = @gateway.purchase(@amount-1, nil, @options)
