...
class RemoteFirstdataE4V14Test < Test::Unit::TestCase
  def setup
    @gateway = FirstdataE4V14Gateway.new(fixtures(:firstdata_e4))
  ...
  def test_invalid_login
    gateway = FirstdataE4V14Gateway.new(:login      => 'NotARealUser',
