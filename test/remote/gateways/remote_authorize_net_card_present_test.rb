...
class AuthorizeNetCardPresentTest < Test::Unit::TestCase
  ...
  def test_successful_purchase_with_track1_card_present
    track1_card_present = credit_card(nil, :track1 => "B4111111111111111^JOE/SCHMOE          ^#{(@year + 1)}01101150250000000000534000000")
  ...
  def test_successful_purchase_with_track2_card_present
    track2_card_present = credit_card(nil, :track2 => "4007000000027=#{(@year + 1)}12XXXXXXXXXXX")
  ...
  def test_expired_credit_card_with_card_present
    track1_expired_card_present = credit_card(nil, :track1 => "B4111111111111111^JOE/SCHMOE          ^#{(@year - 1)}01101150250000000000534000000")
