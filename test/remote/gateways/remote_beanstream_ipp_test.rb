...
class RemoteBeanstreamIppTest < Test::Unit::TestCase
  def setup
    ...
    @credit_card_visa_declined_5 = credit_card('4123456789010053')

    @credit_card_mastercard = credit_card('5123456789012346')

    @credit_card_mastercard_declined_4 = credit_card('5123456789010043')
  ...
  def test_failed_purchase
    response = @gateway.purchase(@amount, @credit_card_visa_declined_5, @options)
  ...
  def test_failed_purchase_mastercard
    response = @gateway.purchase(@amount, @credit_card_mastercard_declined_4, @options)
