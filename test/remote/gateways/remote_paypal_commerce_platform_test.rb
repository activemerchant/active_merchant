...
class RemotePayPalCommercePlatformTest < Test::Unit::TestCase
  def setup
  ...
  def test_invalid_login
    gateway = PaypalCommercePlatformGateway.new(client_id: 'InvalidKey', secret: 'InvalidSecret', bn_code: 'Invalid')
