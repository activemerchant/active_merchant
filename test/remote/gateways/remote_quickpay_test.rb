...
class RemoteQuickpayTest < Test::Unit::TestCase
  ...
  def test_successful_purchase_without_api_key
    # This test assumes that you have added your IP in the Quickpay manager
    you_added_your_ip_in_the_quick_pay_manager = false
    if you_added_your_ip_in_the_quick_pay_manager
      @gateway = QuickpayGateway.new(fixtures(:quickpay_without_api_key))
  ...
  def test_fraud_input_in_purchase
    @options[:fraud_http_referer] = "http://www.example.org"
