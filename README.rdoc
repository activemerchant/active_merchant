...
Active Merchant uses tests to ensure gateways continue to work. To run tests ; bundle install :
  bundle exec rake test:units   #Should all be passing
  bundle exec rake test:remotes #Will not pass without updating test/fixtures.yml
