    ...
    module Integrations #:nodoc:
      class Helper #:nodoc:
        ...
        def initialize(order, account, options = {})
          options.assert_valid_keys([:amount, :currency, :test, :credential2, :credential3, :credential4, :country, :account_name, :transaction_type, :authcode, :notify_url, :return_url, :redirect_param, :forward_url, :cart_items])
          @fields          = {}
          @raw_html_fields = []
          @test            = options[:test]
          self.order       = order
