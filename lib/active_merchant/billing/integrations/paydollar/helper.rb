    ...
    module Integrations #:nodoc:
	  ...
	  def generate_secure_hash
	    if (@hash_key != nil) then
	      fields = [@fields['merchantId'], @fields['orderRef'], @fields['currCode'], @fields['amount'], @fields['payType'], @hash_key]
	    else 
	      fields = [@fields['merchantId'], @fields['orderRef'], @fields['currCode'], @fields['amount'], @fields['payType']]
	    end
	    fields = fields.join("|")
