module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class ViaklixGateway < Gateway
      ...
      # * <tt>identification</tt> -- The ID of the original transaction against which the refund is being issued.  Viaklik ignores this parameter.
      # * <tt>options</tt> -- A hash of parameters.
      #   * <tt>:credit_card</tt> - The CreditCard details from the initial transaction (required). (Viaklix does not support credits by reference).
