  ...
  module Billing #:nodoc:
    ...
    class CyberSourceGateway < Gateway
      ...
      def add_merchant_descriptor(xml, options)
        return unless options[:merchant_descriptor] || options[:user_po] || options[:taxable] || options[:reference_data_code] || options[:invoice_number] || options[:merchant_descriptor_city] || options[:submerchant_id]
