module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    # For more information on the PayVector Gateway please download the
    # documentation from their Merchant Management System.
    #
    # The login and password are not the username and password you use to
    # login to the PayVector Merchant Management System. Instead, you will
    # use the API username and password you were issued separately.
    class PayVectorGateway < Gateway
      self.live_url = self.test_url = 'https://gw1.payvector.net/'
      ...
      self.homepage_url = 'http://www.payvector.co.uk/'

      # The name of the gateway
      self.display_name = 'PayVector'
