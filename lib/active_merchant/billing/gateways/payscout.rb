...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class PayscoutGateway < Gateway
      self.test_url = 'https://secure.payscout.com/api/transact.php'
      self.live_url = 'https://secure.payscout.com/api/transact.php'
      ...
      self.homepage_url = 'http://www.payscout.nom/'
