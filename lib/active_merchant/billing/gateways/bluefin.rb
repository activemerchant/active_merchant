module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    ...
    #
    # Bluefin uses EZIC.com gateway.  So, if needed, this code could 
    # be pulled out into a EZIC class and have this class subclass it 
    # overriding the urls and meta data as needed.
    #
    class BluefinGateway < Gateway
