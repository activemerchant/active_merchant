...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class PrismpayGateway < Gateway
      self.display_name = "Prism Pay"
      self.homepage_url = "http://www.myprismpay.com/"

      self.live_url = "https://trans.myprismpay.com/cgi-bin/ProcessXML.cgi"
