module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class PinGateway < Gateway
      ...
      # Create a customer and associated credit card. The token that is returned can be
      # used instead of a credit card parameter in the purchase method
      ...
      # Refund a transaction, note that the money attribute is ignored at the moment
      # As the API does not support partial refunds. THe parameter is kept for compatibility reasons
