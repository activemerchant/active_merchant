  ...
  module Billing #:nodoc:
    class AdyenGateway < Gateway
      ...
      def skip_mpi_data?(payment, options = {})
        ...
        options[:wallet_type] || (!options.dig(:stored_credential, :initial_transaction) && options.dig(:stored_credential, :initiator) == 'merchant' && options[:switch_cryptogram_mapping_nt])
      end
