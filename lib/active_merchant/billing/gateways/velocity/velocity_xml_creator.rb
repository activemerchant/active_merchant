...
module Velocity
  ...
  # It returns xml format in string.
    ...
    def return_unlinked_xml(params)
        Nokogiri::XML::Builder.new do |xml|
  ...
  # It returns JSON format in string.
    ...
    def query_transactions_detail_json(params)
         {  
    ...
    def transaction_date_range(params)
       if !params[:EndDateTime].nil? && !params[:StartDateTime].nil?
        {
    ...
    def capture_date_range(params)
      if !params[:EndDateTime1].nil? && !params[:StartDateTime1].nil?
        {
    ...
    def mer_pro_ids(params)
      if !params[:MerchantProfileIds].nil?
    ...
    def transaction_states(params)
      if !params[:TransactionStates].nil?
