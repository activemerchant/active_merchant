  ...
  module Billing # :nodoc:
    ...
    class StripePaymentIntentsGateway < StripeGateway
      ...
      def add_aft_recipient_details(post, options)
        ...
        address = recipient_details[:address] if recipient_details[:address]
        account_details = recipient_details[:account_details] if recipient_details[:account_details]
        ...
        post[:payment_method_options][:card][:recipient_details][:account_details][:card][:first6] = account_details[:card][:first6] if account_details[:card][:first6]
        post[:payment_method_options][:card][:recipient_details][:account_details][:card][:last4] = account_details[:card][:last4] if account_details[:card][:last4]
        post[:payment_method_options][:card][:recipient_details][:account_details][:unique_identifier][:identifier] = account_details[:unique_identifier][:identifier] if account_details[:unique_identifier][:identifier]
      end
      ...
      def add_aft_sender_details(post, options)
        ...
        address = sender_details[:address] if sender_details[:address]
        dob = sender_details[:dob] if sender_details[:dob]
