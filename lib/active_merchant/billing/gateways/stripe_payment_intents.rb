  ...
  module Billing # :nodoc:
    ...
    class StripePaymentIntentsGateway < StripeGateway
      ...
      def add_aft_recipient_details(post, options)
        ...
        if address = recipient_details[:address]
        ...
        if account_details = recipient_details[:account_details]
          post[:payment_method_options][:card][:recipient_details][:account_details] = {}

          if card = account_details[:card]
          ...
          if (unique_identifier = account_details[:unique_identifier]) && (unique_identifier[:identifier])
            post[:payment_method_options][:card][:recipient_details][:account_details][:unique_identifier] = {}
            post[:payment_method_options][:card][:recipient_details][:account_details][:unique_identifier][:identifier] = unique_identifier[:identifier]
          end
        end
      end
      ...
      def add_aft_sender_details(post, options)
        ...
        if address = sender_details[:address]
