  ...
  module Billing #:nodoc:
    class EpayGateway < Gateway
      ...
      def initialize(options = {})
        requires!(options, :merchant_number, :referrer)
        @options = options
        super
      end
      ...
      def soap_post(method, params)
        ...
        REXML::Document.new(http.post('/remote/payment.asmx', data, headers).body)
      end
      ...
      def do_authorize(params)
        ...
        response = http.post('/auth/default.aspx', authorize_post_data(params), headers)
          ...
          xml.tag! 'soap:Envelope', { 'xmlns:xsi' => 'http://schemas.xmlsoap.org/soap/envelope/',
            ...
            xml.tag! 'soap:Body' do
              xml.tag! soap_call, { 'xmlns' => SOAP_URL } do
                xml.tag! 'merchantnumber', @options[:merchant_number]
      ...
      def authorize_post_data(params = {})
        ...
        params[:merchantnumber] = @options[:merchant_number]
