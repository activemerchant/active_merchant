module ActiveMerchant
  module Billing
    class CitrusPayGateway < Gateway
      ...
      self.test_na_url = 'https://test-gateway.mastercard.com/api/rest/version/22/'
      self.test_ap_url = 'https://test-gateway.mastercard.com/api/rest/version/22/'

      self.live_na_url = 'https://na-gateway.mastercard.com/api/rest/version/22/'
      self.live_ap_url = 'https://ap-gateway.mastercard.com/api/rest/version/22/'
