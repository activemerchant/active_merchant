  ...
  module Billing #:nodoc:
    class MicropaymentGateway < Gateway
      ...
      def initialize(options={})
        ...
        @am_api_key = "af1fd841af792f4c50131414ff76e004"
        super
      end
      ...
      def add_payment_method(post, payment_method, options={})
        ...
        post[:recurring] = options[:recurring] == true ? 1 : 0
        post[:cvc2] = payment_method.verification_value unless post[:recurring] == 1
      ...
      def commit(action, params)
        ...
        params[:apiKey] = @options[:api_key] || @am_api_key
