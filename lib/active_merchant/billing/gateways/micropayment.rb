module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class MicropaymentGateway < Gateway
      ...
      # Not supported since it requires gateway tokenization of the card first,
      # as well as a createSession call
      ...
      # Not supported since can't use customerId directly in purchase w/o
      # card number
